...
export default function Announcements() {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16" data-testid="announcements-page">
      ...
      <h1 className="font-display text-5xl sm:text-6xl font-semibold mt-2 text-foreground">Announcements</h1>

      <div className="mt-10 divide-y divide-border border border-border bg-card rounded-sm">
        ...
        {items.map((a) => (
          <article key={a.id} className="p-6 lift" data-testid={`announcement-${a.id}`}>
            ...
            <h2 className="font-display text-2xl font-semibold mt-3 text-foreground">{a.title}</h2>
