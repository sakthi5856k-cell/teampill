...
export const generalGuidelines = [
  {
    ...
    icon: Shield,
    points: [
      "Maintain professional behavior and respect toward all.",
      "Provide medical help even when off duty (ethical obligation).",
      "No weapons or illegal items while on duty.",
      "Uniform and ID must be worn properly.",
      "Strict hierarchical reporting is mandatory.",
    ],
  },
  {
    title: "Patient Care",
    icon: HeartPulse,
    points: [
      "Follow Cities-approved medical protocols.",
      "Mandatory advanced documentation..",
      "Maintain complete patient privacy.",
      "Only Dean authorizes data sharing with PD.",
      "Transport patients safely to hospital.",
    ],
  },
  {
